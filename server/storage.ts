...
export interface IStorage {
  ...
  getGrnByNumber(grnNumber: string): Promise<GoodsReceivedNote | undefined>;
  getAllGrns(): Promise<GoodsReceivedNote[]>;
  getGrnsByVendorPo(vendorPoId: string): Promise<GoodsReceivedNote[]>;
  createGrn(grn: InsertGrn & { createdBy: string; grnNumber: string }): Promise<GoodsReceivedNote>;
  updateGrn(id: string, data: Partial<GoodsReceivedNote>): Promise<GoodsReceivedNote | undefined>;
